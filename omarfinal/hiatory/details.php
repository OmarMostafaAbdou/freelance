...
<nav class="nav  navbar-nav fixed-top">
   ...
   <div class=" d-flex flex-column justify-content-center w-100 p-3 details">
    
<div class="cards shadow">
<div class="center-carousel">

    
<div class="col-md-5 w-65">
    <div id="carouselExampleIndicators" class="carousel slide">
        ...
        <div class="carousel-inner">
          ...
          <div class="carousel-item active">
            <img src="../pics/<?php echo''.$images[0]['imgs'].'';  ?>" class="d-block w-100 p-3 " alt="...">
          </div>
          <?php foreach($images as $image){
          echo'

          <div class="carousel-item">
            <img src="../pics/'.$image["imgs"].'" class="d-block w-100 p-3 " alt="...">
          </div>
...
<div class="mmm">
    ...
    <p style="overflow-wrap: break-word; width:70% ;    font-size:20px ;    ">'.$details["description"].'</p>
    <div class="price">'.$details["price"].' جنيه </div>
    <div class="control d-flex justify-content-center">
    <a href="../edit.php?id='.$details['id'].'"class="btn ">تعديل</a> 
    <a href="delete.php?id='.$details['id'].'"class="btn">حذف</a>
    </div>
