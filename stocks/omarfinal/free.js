...
const help_but = document.querySelector(".help_but");
const videoContainer = document.querySelector(".video-application"); // Fix the typo
...
function history() {
  location.assign("E:/needs/history.html")
}
