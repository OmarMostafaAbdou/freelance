...
<nav class="navbar bg-body-tertiary fixed-top"  >
        ...
        <div>
            ...
            <div class="model">
               <div class="up">
               <a href="history/history.php" class="sbtn">سجل الخدمات</a>
                <a href="#" class="vbtn">للمساعدة</a>
               </div>
                    ...
                    <form action="" method="POST" enctype="multipart/form-data">
                        <div class="page slide-page">
                            ...
                            <div class="field">
                                ...
                                <input type="text" name="jobname" value="<?php echo $item["title"];?>">
                            </div>
                            <div class="field">
                                <div class="label">
                                    قسم الخدمة
                ...
                <!-- Add more categories as needed -->
                        ...
                        <div class="page">
                            ...
                            <div class="field">
                                ...
                                <textarea name="description" id="" cols="45" rows="5" placeholder="وصف العمل" >
