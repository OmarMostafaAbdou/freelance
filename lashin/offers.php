...
<body>
  <nav>
    ...
    <header class="painting-section">
      <h2></h2>
      <img src="pics/painters.jpg" style="background-color: rebeccapurple;" alt="" srcset="">
    </header>
    <div class="users">
...
foreach ($clients as $client) {
  echo"
  <a class='user'  href='user_profile.php?id=$client[id]'>
<div >

  <h4>$client[name] </h4>
  <p>الوصف:$client[description]</p>
  <h5>السعر:$client[price]</h5>
  <p>موبايل:$client[phone]</p>
</div>
</a>
  ";
}
