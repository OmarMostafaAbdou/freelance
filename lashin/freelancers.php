...
$freelancers = getFreelancers($id);
$categoris=getCatById($id);
...
<body>
    ...
    <header class="painting-section">
<?php
foreach ($categoris as $category) {
  echo"
  <h1>$category[name] </h1>
  <img src='./pics/header/$category[img]' alt='' srcset=''>";
}
...
<?php 
        ...
        foreach ($freelancers as $freelancer) {
          ...
          <a href='freelancer_profile.php?freelancer_id=$freelancer[id]&service_id=$freelancer[service_id]' class='user'>
          <img src='pics/$freelancer[img]'>
          <h4>$freelancer[name]</h4>
          <h5>$freelancer[service_name]</h5>
          <button class='m-btn'>المزيد</button>
         </a>
...
>
© 2020 Copyright:
<a class="text-dark" href="https://iti.gov.eg/"
>Iti Aswan.com</a
>
</div>
<!-- Copyright -->
