            ...
            <div class="col">
                ...
                <form method="post" action="includes/signup.inc.php">
                    ...
                    <div class="input-group mb-3">
                        <input name="firstname" type="text" class="form-control" id="firstname" placeholder="الأسم الأول">
                    </div>
                    <div class="input-group mb-3">
                        <input name="lastname" type="text" class="form-control" id="lastname" placeholder="الأسم الأخير">
                    </div>
