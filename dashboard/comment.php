...
if(!empty($_GET)){
    $comment=searchForcomment($_GET["comment"]);
}else{
$comment=getcomment();
}
?>
    ...
    <div class="a-main-content">
        <div class="a-header-wrapper">
            ...
            <div class="a-user-info">
                <form class="a-search-box" action="">
                    ...
                    <input type="text" placeholder="بحث..." name="comment" id="">
                </form>
            </div>
        ...
        <div class=" w3-container">
            ...
            <table class="w3-table-all w3-card-4">
               ...
               echo"
                    <td>
                    <a href='deletecomment.php?id=$row[id]'class='btn'><i class='fa-solid fa-trash' style='color: #ff0f0f;'></i></a>
                    </td>
