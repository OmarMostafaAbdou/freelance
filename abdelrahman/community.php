          ...
          <div class="row">
            ...
            <div id="header-group" class="row">
              <div class="heading col-lg-9 col-8 full_width">
                <div class="row mt-3">
                  <h4>نماذج أعمال قمت بتنفيذها</h4>
                </div>
              </div>
              <div class="col-lg-3 col-4 full_width">
                <button type="submit" class="add-btn"   onclick="GoToDetails()"><i class="fa-solid fa-plus" ></i> موضوع جديد
                </button>
              </div>
            </div>
          </div>
          ...
          <div class="grid" style="--bs-columns: 10; --bs-gap: 1rem;">
            <div class="g-col-6">
              ...
              foreach ($result as  $user) {
                echo"
                <div class='user'>
                <img src='imgs/person.png' class='user-img'>
